...
ORG:IJG namibia
EMAIL;type=WORK: mark@ijg.net
TEL;type=CELL: +264819583510
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white shadow-xl">
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Mark Spath</h1>
                <p className="text-lg font-medium text-[#094794]">Group Managing Director</p>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto: mark@ijg.net" className="text-sm text-gray-700 hover:text-[#094794]">
                    mark@ijg.net
                  </a>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+264819583510" className="text-sm text-gray-700 hover:text-[#094794]">
                    +264819583510
                  </a>
                </div>
              </div>
